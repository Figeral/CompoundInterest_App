package compoundinterest.src.main.java.com.figeral;
...
public class CompoundInterest04 {
  ...
  public void perform() {
        var result = calculateCompoundInterest();
            System.out.printf("If you deposit %s in a savingsaccount " + "that pays %s annual interest compounded monthly%n" + "you will have after %1.0f years %s",
      ...
      private double calculateCompoundInterest() {
        ...
        public static void main(String[] args) {
           var banker = new CompoundInterest04();
           banker.perform();
        }
}